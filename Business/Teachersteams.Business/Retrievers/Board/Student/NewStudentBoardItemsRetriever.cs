...
namespace Teachersteams.Business.Retrievers.Board.Student
{
    ...
    public class NewStudentBoardItemsRetriever: IStudentBoardItemsRetriever
    {
        ...
        public IEnumerable<StudentBoardItemViewModel> Retrieve(string studentUid, GridOptions gridOptions)
        {
            ...
            {
                FilterRules = x => groupIds.Contains(x.GroupId) && x.Results.All(r => r.Student.Uid != studentUid) && x.Status == AssignmentStatus.Active,
            ...
            //        item.AssigneeTeacherId = result.AssigneeTeacherId;
