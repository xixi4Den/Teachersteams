...
{
    [TeacherBoardItemsRetrieverMeta(TeacherBoardCompositeFilterType.CheckedAssignedToMe)]
    public class CheckedAssignedToMeTeacherBoardItemsRetriever: BaseTeacherBoardItemsRetriever
    {
        public CheckedAssignedToMeTeacherBoardItemsRetriever(IUnitOfWork unitOfWork, IMapper mapper, IGridOptionsHelper gridOptionsHelper) 
