...
{
    [TeacherBoardItemsRetrieverMeta(TeacherBoardCompositeFilterType.UncheckedAssignedToOthers)]
    public class UncheckedAssignedToOthersTeacherBoardItemsRetriever : BaseTeacherBoardItemsRetriever
    {
        public UncheckedAssignedToOthersTeacherBoardItemsRetriever(IUnitOfWork unitOfWork, IMapper mapper, IGridOptionsHelper gridOptionsHelper) 
