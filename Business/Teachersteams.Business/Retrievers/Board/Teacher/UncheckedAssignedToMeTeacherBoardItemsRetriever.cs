...
{
    [TeacherBoardItemsRetrieverMeta(TeacherBoardCompositeFilterType.UncheckedAssignedToMe)]
    public class UncheckedAssignedToMeTeacherBoardItemsRetriever: BaseTeacherBoardItemsRetriever
    {
        public UncheckedAssignedToMeTeacherBoardItemsRetriever(IUnitOfWork unitOfWork, IMapper mapper, IGridOptionsHelper gridOptionsHelper) 
